        ...
        <div className=''>
            ...
            <div className='w-[100%] '>
                <table className='w-[100%]'>
                    ...
                    <tbody>
                        {
                            recruiterList?.map((item, index) => <tr key={index}>
                                ...
                                <td className='border-2 border-black px-10  py-4 font-semibold'><div className={`${item.status === 'true' ? 'text-blue-800':"text-red-600"}`}>{item.status}</div></td>
                                <td className='border-2 border-black px-10  py-4 font-semibold'><div className={`${item.emailVerify == 'verified' ? 'text-green-500':"text-red-600"}`}>{item.emailVerify}</div></td>
                                <td className='border-2 border-black px-10  py-4 font-semibold'><div className={`${item.adminVerify == 'verified' ? 'text-green-500':"text-red-600"}`}>{item.adminVerify}</div></td>
                            </tr>
                            )
